...
for i=1:rm          %在中频段嵌入水印
    for j=1:cm
        ...
        y=(j-1)*4;
        if mark(i,j)==1
            if(before(x+1,y+4) > 0) after(x+1,y+4)=before(x+1,y+4)*2 + 3;
            else after(x+1,y+4)=before(x+1,y+4)*2 - 3; end
            if(before(x+2,y+3) > 0) after(x+2,y+3)=before(x+2,y+3)*2 + 3;
            else after(x+2,y+3)=before(x+2,y+3)*2 - 3; end
            if(before(x+3,y+2) > 0) after(x+3,y+2)=before(x+3,y+2)*2 + 3;
            else after(x+3,y+2)=before(x+3,y+2)*2 - 3; end
            if(after(x+4,y+1) > 0) after(x+4,y+1)=before(x+4,y+1)*2 + 3;
            else after(x+4,y+1)=before(x+4,y+1)*2 - 3; end
        else
            if(before(x+1,y+4) > 0) after(x+1,y+4)=before(x+1,y+4)/2;
            else after(x+1,y+4)=before(x+1,y+4)/2; end
            if(before(x+2,y+3) > 0) after(x+2,y+3)=before(x+2,y+3)/2;
            else after(x+2,y+3)=before(x+2,y+3)/2; end
            if(before(x+3,y+2) > 0) after(x+3,y+2)=before(x+3,y+2)/2;
            else after(x+3,y+2)=before(x+3,y+2)/2; end
            if(after(x+4,y+1) > 0) after(x+4,y+1)=before(x+4,y+1)/2;
            else after(x+4,y+1)=before(x+4,y+1)/2; end  
        end;
...
p(3)=after_2(x+3,y+2);
p(4)=after_2(x+4,y+1);
if (abs(p(1))+abs(p(2))+abs(p(3))+abs(p(4))) < 15  %corr2计算两个矩阵的相似度，越接近1相似度越大
