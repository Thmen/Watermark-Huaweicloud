...
set C_modelArgList {
	...
	{ dst int 16 regular {array 16 { 0 0 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	...
	dst { ap_memory {  { dst_address0 mem_address 1 4 }  { dst_ce0 mem_ce 1 1 }  { dst_we0 mem_we 1 1 }  { dst_d0 mem_din 1 16 }  { dst_address1 mem_address 1 4 }  { dst_ce1 mem_ce 1 1 }  { dst_we1 mem_we 1 1 }  { dst_d1 mem_din 1 16 } } }
}
