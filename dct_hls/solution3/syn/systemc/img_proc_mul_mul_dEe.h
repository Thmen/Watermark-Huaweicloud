...
#ifndef __img_proc_mul_mul_dEe__HH__
#define __img_proc_mul_mul_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(img_proc_mul_mul_dEe) {
    ...
    SC_CTOR(img_proc_mul_mul_dEe):  ACMP_smul_us_U ("ACMP_smul_us_U") {
