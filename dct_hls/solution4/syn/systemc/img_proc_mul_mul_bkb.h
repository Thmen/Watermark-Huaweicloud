...
#ifndef __img_proc_mul_mul_bkb__HH__
#define __img_proc_mul_mul_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(img_proc_mul_mul_bkb) {
    ...
    SC_CTOR(img_proc_mul_mul_bkb):  ACMP_smul_su_U ("ACMP_smul_su_U") {
