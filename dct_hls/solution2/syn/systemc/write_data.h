...
struct write_data : public sc_module {
    ...
    sc_signal< sc_lv<8> > ap_port_reg_buf_0_2_read;
    sc_signal< sc_lv<8> > ap_port_reg_buf_0_3_read;
    sc_signal< sc_lv<8> > ap_port_reg_buf_1_0_read;
    sc_signal< sc_lv<8> > ap_port_reg_buf_1_1_read;
    sc_signal< sc_lv<8> > ap_port_reg_buf_1_2_read;
    sc_signal< sc_lv<8> > ap_port_reg_buf_1_3_read;
    sc_signal< sc_lv<8> > ap_port_reg_buf_2_0_read;
    sc_signal< sc_lv<8> > ap_port_reg_buf_2_1_read;
    sc_signal< sc_lv<8> > ap_port_reg_buf_2_2_read;
    sc_signal< sc_lv<8> > ap_port_reg_buf_2_3_read;
    sc_signal< sc_lv<8> > ap_port_reg_buf_3_0_read;
    sc_signal< sc_lv<8> > ap_port_reg_buf_3_1_read;
    sc_signal< sc_lv<8> > ap_port_reg_buf_3_2_read;
    sc_signal< sc_lv<8> > ap_port_reg_buf_3_3_read;
