...
#ifndef __add_watermark_mulcud__HH__
#define __add_watermark_mulcud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(add_watermark_mulcud) {
    ...
    SC_CTOR(add_watermark_mulcud):  ACMP_smul_su_U ("ACMP_smul_su_U") {
